...
TENSORBOARD_PATH="/scratch/project_462000353/villekom/logs/europa-production/tensorboard/v3-33B.$SLURM_JOB_ID"

export CUDA_DEVICE_MAX_CONNECTIONS=1

# sets TRAIN_DATA and VALIDATION_DATA
source $wd/dataset/europa_data.sh
...
export PYTHONPATH=/scratch/project_462000353/europa-production/pythonuserbase/lib/python3.10/site-packages
